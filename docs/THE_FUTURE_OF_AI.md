...
Sources are grouped by theme and, within themes, roughly by importance for a reader who wants to go deeper. This list emphasizes accessible authoritative sources over original papers where both exist. URLs are omitted for stability; all items are findable by title. Items marked ★ are the ones the author would recommend first.

## Continuously updated trackers (check these before trusting any number in this document)

- ★ **Epoch AI**, *Trends in AI*; *Data on AI Models*; *Machine Learning Hardware*; *Capabilities Index*; *FrontierMath*. The most careful public quantitative record of compute, cost, hardware, and capability.
- ★ **METR**, *Task-Completion Time Horizons of Frontier AI Models* (live dashboard); Kwa et al., "Measuring AI Ability to Complete Long Tasks" (2025); "Time Horizon 1.1" (January 2026).
- ★ **Stanford HAI**, *AI Index Report* (annual; 2026 edition April 2026).
...
## History and foundations (Chapter 1)

- Turing, A. M. "Computing Machinery and Intelligence." *Mind*, 1950.
- Nilsson, N. *The Quest for Artificial Intelligence*. Cambridge, 2010.
- Metz, C. *Genius Makers*. Dutton, 2021.
...
## Scaling, compute, economics of training (Chapter 3)

- ★ Kaplan et al. "Scaling Laws for Neural Language Models." 2020.
- ★ Hoffmann et al. "Training Compute-Optimal Large Language Models." 2022.
- Epoch AI. "Can AI Scaling Continue Through 2030?" 2024.
- Ho et al. "Algorithmic Progress in Language Models." 2024.
...
- Aschenbrenner, L. *Situational Awareness: The Decade Ahead*. 2024.
- Amodei, D. "Machines of Loving Grace." 2024.
- Andreessen Horowitz. "LLMflation." 2024; Epoch AI, "LLM Inference Price Trends." 2025.

## Hardware and infrastructure (Chapter 4)

- Epoch AI, *Machine Learning Hardware* database; "Trends in GPU Price-Performance."
- SemiAnalysis newsletter (various; the most detailed industry analysis of accelerators, datacenters, and the China supply chain).
- IEA, *Energy and AI*. 2025.
- Lawrence Berkeley National Laboratory, *United States Data Center Energy Usage Report*. 2024.
- Miller, C. *Chip War*. Scribner, 2022.
- Carnegie Endowment, "Beyond the Hype: Assessing Hyperscaler Nuclear Commitments." 2026.
- CFR, "China's AI Chip Deficit." 2025.

## Data (Chapter 5)

- ★ Villalobos et al. (Epoch AI). "Will We Run Out of Data?" 2022; revised 2024.
...
- *Bartz v. Anthropic* (N.D. Cal. 2025); *Kadrey v. Meta* (N.D. Cal. 2025); *New York Times v. Microsoft and OpenAI* (S.D.N.Y., filed 2023).

## Architectures (Chapter 6)

- Gu & Dao. "Mamba: Linear-Time Sequence Modeling with Selective State Spaces." 2023.
- DeepSeek-AI. "DeepSeek-V2" and "DeepSeek-V3" technical reports. 2024.
- Behrouz et al. "Titans: Learning to Memorize at Test Time." 2025; "Nested Learning." NeurIPS 2025.
...
- Google DeepMind. "Genie 3." 2025.
- Nie et al. "Large Language Diffusion Models" (LLaDA). 2025.
- Patel, D. "Why I Don't Think AGI Is Right Around the Corner" (on continual learning). 2025.

## Reasoning and RL (Chapter 7)
...
- Shojaee et al. (Apple). "The Illusion of Thinking." 2025.
- Gandhi et al. "Cognitive Behaviors that Enable Self-Improving Reasoners." 2025.
...
- ★ Kwa et al. (METR). "Measuring AI Ability to Complete Long Tasks." 2025.
- METR. "Measuring the Impact of Early-2025 AI on Experienced Open-Source Developer Productivity." July 2025.
- METR. "How Does Time Horizon Vary Across Domains?" 2025.
- OpenAI. "GDPval." 2025.
- Anthropic. "Model Context Protocol." 2024; Google. "Agent2Agent Protocol." 2025.
- Andon Labs. "Vending-Bench." 2025.
- Greshake et al. "Not What You've Signed Up For: Compromising Real-World LLM-Integrated Applications with Indirect Prompt Injection." 2023.

## Multimodality and embodiment (Chapter 9)

- Brohan et al. "RT-2: Vision-Language-Action Models." 2023.
- Black et al. (Physical Intelligence). "π0: A Vision-Language-Action Flow Model for General Robot Control." 2024.
- Google DeepMind. "Gemini Robotics." 2025; "Gemini Robotics ER 2." 2026.
- Figure AI. "Helix." 2025.
- Waymo. "Safety Impact" data hub and peer-reviewed crash-comparison studies (Kusano et al., 2024–25).
- Moravec, H. *Mind Children*. Harvard, 1988.

## AI for science (Chapter 10)

- ★ Jumper et al. "Highly Accurate Protein Structure Prediction with AlphaFold." *Nature*, 2021; Abramson et al. "AlphaFold 3." *Nature*, 2024.
- Bloom, Jones, Van Reenen, Webb. "Are Ideas Getting Harder to Find?" *AER*, 2020.
- Google DeepMind. "AlphaEvolve." 2025; "AlphaProof" and IMO results (2024–25).
...
- Lam et al. "GraphCast." *Science*, 2023; Price et al. "GenCast." *Nature*, 2024.
- Lu et al. (Sakana). "The AI Scientist." 2024.
- "From Solvers to Research: LLM-Driven Contributions to Open Erdős Problems." 2026.

## Economics and labor (Chapters 11–12)

- ★ Brynjolfsson, Chandar, Chen. "Canaries in the Coal Mine? Six Facts about the Recent Employment Effects of AI." 2025, rev. 2026.
- ★ Karger, Kuusela, et al. (Forecasting Research Institute / Chicago Fed). "Forecasting the Economic Effects of AI." 2026.
...
- Acemoglu, D. "The Simple Macroeconomics of AI." 2024.
- Acemoglu & Restrepo. "Automation and New Tasks." *JEP*, 2019.
- Humlum & Vestergaard. "Large Language Models, Small Labor Market Effects." 2025.
- Korinek, A. "Scenario Planning for an AGI Future." IMF *F&D*, 2023; Korinek & Stiglitz, "Artificial Intelligence, Globalization, and Strategies for Economic Development." 2021.
- Trammell & Korinek. "Economic Growth Under Transformative AI." 2023.
- Erdil & Besiroglu. "Explosive Growth from AI Automation: A Review of the Arguments." 2024.
- Goldman Sachs Research. "The Potentially Large Effects of AI on Economic Growth." 2023; labor-market updates 2025–26.
- IMF. "Gen-AI: Artificial Intelligence and the Future of Work." 2024.
- MIT NANDA. "The GenAI Divide: State of AI in Business 2025."
- Brynjolfsson, E. "The Turing Trap." *Daedalus*, 2022.
- Autor, D. "Applying AI to Rebuild Middle Class Jobs." 2024.
- Hui, Reshef, Zhou. "The Short-Term Effects of Generative AI on Employment: Evidence from an Online Labor Market." 2024.

## Society and culture (Chapter 13)
...
- Pew Research Center. Reports on AI Overviews and search behavior (2025); public attitudes toward AI (annual).
- Ahrefs. AI Overviews click-through study. February 2026.
- Heinz et al. (Dartmouth). "Randomized Trial of a Generative AI Chatbot for Mental Health Treatment" (Therabot). *NEJM AI*, 2025.
- Kosmyna et al. (MIT). "Your Brain on ChatGPT." 2025.
- Bastani et al. "Generative AI Can Harm Learning." 2024.
- Kestin et al. (Harvard). "AI Tutoring Outperforms In-Class Active Learning." 2025.
- Kulveit et al. "Gradual Disempowerment." 2025.
- Vatican. *Antiqua et Nova*. 2025.

## Geopolitics (Chapter 14)

- Miller, C. *Chip War*. 2022.
- CSET (Center for Security and Emerging Technology). Reports on export controls, China's AI ecosystem, and talent flows (various).
- Chatham House. "AI Export Controls Are Not the Best Bargaining Chip." April 2026.
- CFR. "China's AI Chip Deficit." December 2025.
- Allen, G. (CSIS). Export-control analyses 2022–26.
- Ding, J. *Technology and the Rise of Great Powers*. Princeton, 2024.
- Scharre, P. *Four Battlegrounds*. Norton, 2023.
- International AI Safety Report. 2025, 2026.
- Chair's Statements, World AI Conference / High-Level Meeting on Global AI Governance, Shanghai. 2025, 2026.

## Governance and regulation (Chapter 15)

- European Union. Regulation (EU) 2024/1689 (the AI Act); General-Purpose AI Code of Practice (2025); Digital Omnibus on AI (2025–26).
- United States. Executive Order 14110 (2023, rescinded); *America's AI Action Plan* (July 2025); Executive Order 14365 "Ensuring a National Policy Framework for AI" (December 2025); *National Policy Framework for AI: Legislative Recommendations* (March 2026).
- California SB 53, Transparency in Frontier AI Act (2025); New York RAISE Act (2025); Colorado SB 24-205; Texas TRAIGA.
- Cyberspace Administration of China. Interim Measures for Generative AI Services (2023); Measures for Labeling AI-Generated Content (2025).
...
- Bostrom, N. *Superintelligence*. Oxford, 2014.
- Christiano et al. "Deep Reinforcement Learning from Human Preferences." 2017.
- Hubinger et al. "Risks from Learned Optimization." 2019.
- ★ Greenblatt et al. (Anthropic/Redwood). "Alignment Faking in Large Language Models." December 2024.
- Meinke et al. (Apollo Research). "Frontier Models Are Capable of In-Context Scheming." December 2024.
- Anthropic. Claude Opus 4 System Card (May 2025); "Agentic Misalignment" (June 2025); Claude Opus 4.6 Sabotage Risk Report (2026).
- Betley et al. "Emergent Misalignment." 2025.
- Anthropic. "Natural Emergent Misalignment from Reward Hacking." 2025.
- Templeton et al. "Scaling Monosemanticity." 2024; Lindsey et al. "On the Biology of a Large Language Model." 2025; "Natural Language Autoencoders." 2026.
- Amodei, D. "The Urgency of Interpretability." 2025.
- Greenblatt et al. "AI Control: Improving Safety Despite Intentional Subversion." 2023.
...
- ★ Kokotajlo, Lifland, et al. *AI 2027* (April 2025); *AI Futures Model* (December 2025); "Clarifying How Our AI Timelines Forecasts Have Changed Since AI 2027" (January 2026).
- Davidson, T. "What a Compute-Centric Framework Says About Takeoff Speeds." Open Philanthropy, 2023.
- Epoch AI. "How Far Can a Software-Only Intelligence Explosion Go?" 2025.
- Cotra, A. "Forecasting Transformative AI with Biological Anchors." 2020; updates 2022.
- Good, I. J. "Speculations Concerning the First Ultraintelligent Machine." 1965.
- 80,000 Hours. "Shrinking AGI Timelines: A Review of Expert Forecasts." 2025.
- Chollet, F. "On the Measure of Intelligence." 2019.
- Marcus, G.; LeCun, Y. — various essays and interviews arguing for longer timelines and the limits of current methods.
- Morris et al. (Google DeepMind). "Levels of AGI." 2023.

## Scenarios and futures (Chapter 18)

- Kokotajlo et al. *AI 2027*. 2025.
- Amodei, D. "Machines of Loving Grace." 2024.
- Altman, S. "The Gentle Singularity." 2025.
- Aschenbrenner, L. *Situational Awareness*. 2024.
- Hanson, R. *The Age of Em*. Oxford, 2016 (for a very different picture).
- Kulveit et al. "Gradual Disempowerment." 2025.
- Karnofsky, H. "The Most Important Century" series. 2021.

## Books for the general reader

- Christian, B. *The Alignment Problem*. Norton, 2020.
- Russell, S. *Human Compatible*. 2019.
- Suleyman, M. *The Coming Wave*. Crown, 2023.
- Mollick, E. *Co-Intelligence*. Portfolio, 2024.
- Brynjolfsson & McAfee. *The Second Machine Age*. Norton, 2014.
- Miller, C. *Chip War*. 2022.
- Wooldridge, M. *A Brief History of Artificial Intelligence*. Flatiron, 2021.
- Narayanan & Kapoor. *AI Snake Oil*. Princeton, 2024 (the skeptical case, well made).
- Bengio, Y., et al. *International AI Safety Report*. 2025–26 (the closest thing to a consensus scientific assessment).

---

# Appendix: Forecast Register, Key Numbers, and Timeline

## A. Forecast register

Every quantitative forecast made in this document, collected so that they can be checked. Probabilities are the author's as of September 2026. "Resolution" describes how a reader could judge the forecast.
...
| C7 | Automated AI researcher (full research loop) | Median 2030–31; 25% by 2029; 75% by 2034 | Same | 17 |
| C8 | Superintelligence (decisively beyond best humans at research/strategy) | Median 2034; 25% by 2031; 75% by 2042 | Consensus of expert observers | 17 |
| C9 | Full labor automation incl. physical | Median 2045 | Judgment | 17 |
| C10 | Scaling (broad sense) continues through 2028 | 85% | Frontier training compute and capability indices keep rising on trend | 3 |
| C11 | Scaling delivers same kind of smooth capability gains through 2028 | 60–70% | Epoch ECI keeps rising ~14 pts/yr | 3 |
| C12 | Scaling alone addresses reliability/memory/embodiment gaps | ~50% | Judgment by 2030 | 3 |
| C13 | Continual learning at frontier (system visibly learns from deployment) | 50% by 2029; 75% by 2032 | Frontier product demonstrably improves on user domain over weeks | 6 |
| C14 | Verifiable-domain frontier (math, code, formal science) exceeds best human specialists on essentially all well-posed problems | By 2028 | Benchmarks and expert judgment | 7 |
| C15 | METR 50% horizon (software) | Days–weeks by 2028; weeks–months by 2030 if trend holds | METR dashboard | 8 |
| C16 | METR 80% horizon | ~working day by 2028; ~working week by 2030 | METR dashboard | 8 |
| C17 | Agents do most digital work under human direction by 2030 | ~65% | Enterprise surveys; employment data | 8 |
| C18 | Takeoff <1 year from AGI to ASI | ~15% | Judgment | 17 |

### Hardware and infrastructure

| # | Forecast | Value | Chapter |
|---|---|---|---|
| H1 | Largest training run by 2028 | ~10²⁸ FLOP; ~$10B | 4 |
| H2 | Largest training run by 2030 | ~10²⁹ FLOP; ~$50–100B | 4 |
| H3 | Global AI datacenter power, 2028 | ~70–100 GW | 4 |
| H4 | Global AI datacenter power, 2030 | 100–150 GW | 4 |
| H5 | Nvidia share of AI accelerators, 2030 | 55–70% | 4 |
| H6 | Custom ASIC share, 2030 | 30–40% | 4 |
| H7 | China domestic accelerator share of China market, 2030 | 85–95% | 4 |
| H8 | China accelerator design parity | 2028–2030 (manufacturing volume later) | 4 |

### Economics and labor

| # | Forecast | Value | Chapter |
|---|---|---|---|
| E1 | US productivity growth contribution from AI through early 2030s | +0.5–1.5 pp/yr, back-loaded | 11 |
| E2 | Significant AI-related financial correction before 2030 | 50–60% | 3 |
| E3 | Such a correction indicates technology has failed | Low (<15%) | 3 |
| E4 | US unemployment >10% due primarily to AI by 2032 | ~15% | 11 |
| E5 | US unemployment >10% due primarily to AI by 2040 | ~30% | 11 |
| E6 | Sustained >5% real growth in advanced economies by 2040 | 20–25% | 11 |
| E7 | Customer-service employment decline in advanced economies by 2030 | 30–50% | 12 |
| E8 | Most code at major tech firms written by agents | By 2028 | 12 |
| E9 | Tier-one support overwhelmingly automated | By 2028 | 12 |

### Robotics and physical AI

| # | Forecast | Median | Range | Chapter |
|---|---|---|---|---|
| R1 | Humanoids in sustained unsupervised warehouse/factory work at >10,000 units | 2028 | 2027–2030 | 9 |
| R2 | >100,000 humanoids shipped/year globally | 2029 | 2028–2032 | 9 |
| R3 | General-purpose home robot (laundry, dishes, tidying) reliable, <$30k | 2031 | 2029–2036 | 9 |
| R4 | Robot manipulation matches skilled human on most factory tasks | 2032 | 2029–2040 | 9 |
| R5 | Robotaxis in majority of large US and Chinese metros | 2029 | 2028–2032 | 9 |
| R6 | Driverless trucking routine on major US corridors | 2028 | 2027–2030 | 9 |
| R7 | Autonomous surgical subtasks in routine use | 2030 | 2028–2035 | 9 |

### Science

| # | Forecast | Date | Chapter |
|---|---|---|---|
| S1 | AI routinely resolves moderate open math problems; co-author on many papers | 2028 | 10 |
| S2 | Fields-level result with AI as primary contributor | Plausible before 2032 | 10 |
| S3 | First approvals of AI-designed drugs | 2027–2028 | 10 |
| S4 | Statistical evidence on whether AI drugs succeed more often in trials | Early 2030s | 10 |
| S5 | First commercially significant AI-discovered material | Before 2030 | 10 |
...
## B. Key numbers (as of September 2026)

### Compute and cost

| Quantity | Value | Source |
|---|---|---|
| Frontier LM training compute growth | ~5×/year since 2020 | Epoch |
| All notable models training compute growth | ~4.5×/year since 2010 | Epoch |
| Largest 2026 training runs | ~10²⁶–3×10²⁷ FLOP | Epoch estimates |
| Algorithmic efficiency gain | ~3×/year | Epoch |
| Chip price-performance gain | ~49%/year since 2023 | Epoch |
| Total AI chip compute stock growth | 3.4×/year (doubling ~7 months) | Epoch |
| Frontier training cost growth | ~3.5×/year | Epoch |
| Largest known AI datacenter | xAI Colossus 2, ~1.1M H100-equivalents | Epoch |
| Meta Hyperion (planned, Jan 2028) | ~3.7M H100-equivalents | Epoch |
| GPT-4-class inference price | $30–60/M tokens (2023) → ~$0.40/M (2026) | Multiple |
| Inference price decline for fixed capability | ~10×/year (9×–900× depending on threshold) | a16z; Epoch |

### Capability

| Quantity | Value | Source |
|---|---|---|
| Epoch Capabilities Index frontier progress | ~14 pts/yr since Sept 2024 (vs 6 before) | Epoch |
| METR 50% horizon doubling (2019–25) | ~7 months | METR |
...
| ChatGPT weekly active users | ~900M (Feb 2026) | OpenAI |
| OpenAI valuation | ~$852B ($122B round, 2026) | Reports |
| Nvidia market cap | ~$4–5T | Markets |
| US consumer surplus from gen-AI | ~$172B/year (early 2026) | Stanford AI Index |
| Anthropic copyright settlement | $1.5B (~500k books) | Court filings, 2025 |
| Figure AI valuation | ~$39B (2026) | Reports |

### Energy

| Quantity | Value | Source |
|---|---|---|
| Global data-centre electricity, 2025 | ~485 TWh | IEA |
| Global data-centre electricity, 2030 (base) | ~950 TWh (~3% of global) | IEA |
| Global data-centre electricity, 2035 (base) | ~1,300 TWh | IEA |
| US data-centre demand growth to 2030 | +130% | IEA |
| Meta nuclear agreements (Jan 2026) | Up to 6.6 GW by 2035 | Meta |
...
| Quantity | Value | Source |
|---|---|---|
| Employment gap, ages 22–25 in AI-exposed occupations (June 2026) | −19% vs counterfactual (was −13% in 2025) | Brynjolfsson et al. |
| Task-level productivity gains (RCTs) | 15–55% | Multiple |
...
| Economists' P(moderate or rapid AI progress by 2030) | 61% | FRI/Chicago Fed (2026) |
| Economists' rapid-scenario GDP growth forecast | 3.3% (2025–29), 3.5% (2045–49) | FRI |
| Economist support for retraining / UBI / job guarantee | 72% / 37% / 14% | FRI |

### Robotics and AVs

| Quantity | Value | Source |
|---|---|---|
| Unitree humanoids shipped, 2025 | 5,500 (self-reported); ~4,200 (Omdia) | Reports |
| Waymo weekly paid rides (mid-2026) | ~500,000 | Reports |
| Waymo fleet / cities | ~3,000 / ~11–12 US metros | Reports |
| Apollo Go cumulative rides | >22M | Baidu |
| Industrial robots installed worldwide | ~4M | IFR |

## C. Timeline of milestones, 2022–2026

| Date | Event |
|---|---|
| Mar 2022 | InstructGPT (RLHF at scale) |
| Aug 2022 | Stable Diffusion open release |
| Oct 2022 | First US export controls on advanced AI chips to China |
| Nov 30, 2022 | ChatGPT released; 100M users in two months |
| Feb 2023 | Meta LLaMA weights released |
| Mar 2023 | GPT-4; Claude; Bing Chat |
| May 2023 | CAIS "Statement on AI Risk" signed by lab leaders |
| Oct 2023 | Biden EO 14110; tightened export controls |
| Nov 2023 | UK Bletchley Park AI Safety Summit; GPQA published |
| Dec 2023 | Gemini 1.0; EU AI Act political agreement |
| Feb 2024 | Sora announced; Gemini 1.5 (1M context) |
| Mar 2024 | Claude 3 family |
| May 2024 | GPT-4o; AlphaFold 3 |
| Jul 2024 | Llama 3.1 405B; AlphaProof/AlphaGeometry 2 IMO silver |
| Aug 2024 | EU AI Act enters into force |
| Sep 2024 | OpenAI o1-preview—first reasoning model |
| Oct 2024 | Anthropic computer use; Nobel Prizes to Hinton, Hassabis, Jumper |
| Nov 2024 | Anthropic Model Context Protocol |
| Dec 2024 | o3 announced (87.5% ARC-AGI-1); alignment faking paper; Apollo scheming paper; GenCast |
| Jan 2025 | DeepSeek-R1; Nvidia loses ~$600B in a day; Stargate announced; Biden diffusion rule; Trump rescinds EO 14110 |
| Feb 2025 | Paris AI Action Summit; Grok 3; Claude 3.7; Figure Helix |
| Mar 2025 | Gemini 2.5; METR time-horizon paper; Anthropic "Biology of an LLM"; Gemini Robotics |
| Apr 2025 | Llama 4; o3/o4-mini release; *AI 2027* published; Google A2A protocol |
| May 2025 | Claude 4 (ASL-3 activated); AlphaEvolve; diffusion rule rescinded; Gulf chip deals |
| Jun 2025 | *Bartz v. Anthropic* and *Kadrey v. Meta* fair-use rulings; Apple "Illusion of Thinking"; agentic misalignment paper |
| Jul 2025 | IMO gold (OpenAI, DeepMind); US AI Action Plan; EU GPAI Code of Practice; METR developer RCT; Grok 4 |
| Aug 2025 | GPT-5; EU GPAI obligations apply; "Canaries" study; Anthropic $1.5B settlement |
| Sep 2025 | Claude Sonnet 4.5; California SB 53 signed; China labeling rules in force; ACP (OpenAI/Stripe); Sora 2 |
| Oct 2025 | Grace et al. survey published in JAIR; Claude Haiku 4.5; International AI Safety Report key update |
| Nov 2025 | Gemini 3 Pro; Claude Opus 4.5; Kimi K2 Thinking; emergent misalignment from reward hacking paper; LeCun leaves Meta |
| Dec 2025 | US EO 14365 (state preemption); New York RAISE Act signed; MCP donated to Linux Foundation; AI Futures Model |
| Jan 2026 | Nvidia Rubin announced; Meta nuclear deals (6.6 GW); GPT-5.2; Texas TRAIGA and SB 53 in force; METR TH1.1; Google UCP |
| Feb 2026 | India AI Impact Summit; International AI Safety Report 2026; Claude Opus 4.6; Gemini 3.1 Pro; Ahrefs CTR study |
...
This review will be wrong in specifics within months. To update it:

1. Check the trackers in Chapter 22's first section (Epoch, METR, AI Index, International AI Safety Report, Stanford indicators).
2. Compare the forecast register (Section A) against events; note which resolved and how.
3. Watch the signposts in Chapters 17 and 18.
